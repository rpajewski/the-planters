INSERT INTO Plant (common_name, scientific_name, image_url, description, care_level, toxicity, water, filters)
VALUES
    (
        'Chinese Evergreen',
        'Aglaonema',
        'https://www.whiteflowerfarm.com/mas_assets/cache/image/5/9/4/6/22854.Jpg',
        ...
        1,
        'weekly',
        'Low Sunlight, Intermediate, Moderate Water, Humid Environment'
    ),
    (
        "Elephant's Ear",
        'Alocasia',
        'https://www.ourhouseplants.com/imgs-content/Alocasia-leaves.jpg',
    ...
    (
        ...
        0,
        'bi-weekly',
        'Pet Friendly, Low Sunlight, Beginners, Moderate Water, Humid Environment'
    ),
    (
        'Begonia',
        'Begonia',
        'https://www.gardeningknowhow.com/wp-content/uploads/2007/05/begonia-1.jpg',
    ...
    (
        ...
        'https://ae01.alicdn.com/kf/HTB1q5TkbB1D3KVjSZFyq6zuFpXaT.jpg',
        ...
        0,
        'weekly',
        'Pet Friendly, Low Sunlight, Beginners, Light Water'
    ),
    (
        'Cyclamen',
        'Cyclamen',
        'https://assets.eflorist.com/assets/products/PHR_/T91-1A.jpg',
        'There are over 20 species of cyclamen plants native to North Africa and the Mediterranean. The best variety to use as an indoor plant is the cyclamen “persicum”. Cyclamen are compact table plants that produce butterfly-like flowers atop tall upright stems. The flowers come in red, white, pink, and lavender and have a pleasant sweet smell. The distinctive leaves of a cyclamen are heart shaped and marked with a silver design. These relatively small plants, growing only 8”-10” in height, are popular gifts for Thanksgiving, Christmas, and Valentine’s Day. These little gems grow and re-bloom as indoor houseplants for several years.',
        'easy',
        1,
        'twice-weekly',
        'Toxic, Medium Sunlight, Pros, Moderate Water, Cool Environment'
    ),
    (
        'Dumb Cane Plant',
        'Dieffenbachia',
        'https://assets.eflorist.com/site/EF-18170/assets/products/PHR_/sku4121713.jpg',
        ...
        1,
        'weekly',
        'Medium Sunlight, Intermediate, Light Water, Dry Environment'
    ),
    (
        "Marble Queen Pothos",
        'Epipremnum aureum',
        'https://i.pinimg.com/originals/88/ed/4b/88ed4be3648c057921fcbdec9fca8a1b.jpg',
        ...
        1,
        'weekly',
        'Medium Sunlight, Beginners, Light Water, Warm Environment'
    ),
    (
        'Rubber Tree Plant',
        'Ficus elastica',
        'https://cdn.shopify.com/s/files/1/0551/6489/products/Ficus-elastica-150cm_578x.png?v=1540517740',
        ...
        1,
        'monthly',
        'Medium Sunlight, Intermediate, Moderate Water, Dry Environment'
    ),
    (
        'Amaryllis',
        'Hippeastrum',
        'https://static.onecms.io/wp-content/uploads/sites/37/2018/03/15233600/101692437.jpg',
        ...
        1,
        'weekly',
        'Toxic, Direct Sunlight, Beginners, Moderate Water'
    ),
    (
        'Wax Plant',
        "Hoya Carnosa",
        'https://www.guide-to-houseplants.com/images/wax-plant2.jpg',
        ...
        0,
        'bi-weekly',
        'Pet Friendly, Medium Sunlight, Intermediate, Light Water, Humid Environment'
    ),
    (
        'Sensitive Plant',
        'Mimosa pudica',
        'https://i.pinimg.com/736x/df/98/cc/df98cc0bc5aa7359cd2bde89d25d4836.jpg',
        ...
        1,
        'bi-weekly',
        'Pet Friendly, Direct Sunlight, Intermediate, Light Water, Humid Environment'
    ),
    (
        'Boston Fern',
        'Nephrolepis exaltata',
        'https://nestreeo.com/wp-content/uploads/2020/05/Boston-Fern-3.jpg',
        ...
        0,
        'twice-weekly',
        'Pet Friendly, Medium Sunlight, Pros, Light Water, Cool Environment'
    ),
    (
        'Moth Orchid',
        'Phalaenopsis',
        'https://images-na.ssl-images-amazon.com/images/I/71TbciYkF3L._AC_SX679_.jpg',
        'Orchid plants are one of the largest plant species in the world with over 20,000 different varieties. They are long-lived, and with proper care, bloom again and again for many years. The flowers of an orchid plant may be yellow, white, pink, lavender, spotted, or striped. These plants are a beautiful, inexpensive replacement for a cut flower arrangement or just an added delight for any room in your home or office. The Phalaenopsis or Moth Orchid is one of the best and most available varieties. The flowers of a Phalaenopsis plant open off  long arching spikes and often last 2-3 months.',
        'moderate',
        0,
        'weekly',
        'Pet Friendly, Direct Sunlight, Intermediate, Light Water, Dry Environment'
    ),
    (
        'Boat Orchids',
        'Cymbidium',
        'https://i.pinimg.com/originals/2d/59/9e/2d599e22dabf14475fb794affae17ef0.jpg',
        'Cymbidium orchid plants, or Boat orchids, are among the most attractive, popular, and long lasting orchid plants available throughout the world.  The name Cymbidium comes from the greek word Kumbos which means cavity and refers to the shape of the base of the lip of the flower. These plants have long, thin, grass – like leaves. Sturdy stems or spikes emerge from the leaves of the plant and each spike produces 15-30 beautiful waxy- looking orchid flowers. There are over 52 varieties of Cymbidiums, each with a different color and pattern to their flowers. Cymbidium blooms, which often last for months, come in yellow, red, pink, orange, light green, yellowish green, white, cream, and even brown. These plants have the added advantage of being able to bloom during the winter when other orchids cannot. Although Cymbidium orchid plants require a little extra care, their beautiful flowers make it all worthwhile.',
        'moderate',
        0,
        'weekly',
        'Pet Friendly, Medium Sunlight, Pros, Moderate Water, Humid Environment'
    ),
    (
        'Baby Rubber Plant',
        'Peperomia Obtusifolia',
        'https://uaelandscapes.com/wp-content/uploads/2020/06/Peperomia-obtusifolia-Baby-Rubber-Plant3.jpg?v=1593184611',
        ...
        0,
        'weekly',
        'Medium Sunlight, Intermediate, Light Water, Humid Environment'
    ),
    (
        'Heartleaf Philodendron',
        'Philodendron hederaceum',
        'https://i.etsystatic.com/10494852/r/il/2246fa/2047003105/il_570xN.2047003105_jmbu.jpg',
        ...
        0,
        'weekly',
        'Low Sunlight, Beginners, Moderate Water, Dry Environment'
    ),
    (
        'Prayer Plant',
        'Maranta leuconeura',
        'https://cdn.apartmenttherapy.info/image/upload/v1591488413/gen-workflow/product-listing/redprayerplantamz.jpg',
        'The Prayer plant, native to Brazil. Asia, and Africa, is a very unique plant. The large, patterned leaves with hues of red, green, brown, and cream, lift up and fold together each evening as though praying and open again the next morning. Although the flowers of a Prayer plant are small and insignificant, the patches of color on the leaves get darker and more vibrant as the plant matures. Some interesting varieties include the Rabbits Tracks and Herringbone.  A Prayer plant requires a warm humid environment in order to grow well.',
        'difficult',
        0,
        'twice-weekly',
        'Pet Friendly, Low Sunlight, Pros, Light Water, Dry Environment'
    ),
    (
        'Split Leaf Philodendron',
        'Monstera deliciosa',
        'https://i.pinimg.com/originals/6f/61/70/6f617056877b781439b739aac2382ced.jpg',
        ...
        1,
        'weekly',
        'Toxic, Medium Sunlight, Beginners, Light Water, Dry Environment'
    ),
    (
        'Snake Plant',
        'Sansevieria trifasciata',
        'https://naturerabbit.in/wp-content/uploads/2018/08/Nature-Rabbit-Sansevieria-Black-Gold-Snake-plant.jpg',
        ...
        1,
        'monthly',
        'Low Sunlight, Beginners, Light Water, Dry Environment'
    ),
    (
        'Arboricola',
        'Schefflera arboricola',
        'https://www.plantvine.com/plants/Schefflera-Amate-Large.jpg',
        ...
        1,
        'weekly',
        'Direct Sunlight, Beginners, Light Water, Humid Environment'
    ),
    (
        'Gloxinia',
        'Sinningia speciosa',
        'https://www.po.flowerscanadagrowers.com/uploads/2011/10/6245_50.jpg',
        ...
        0,
        'weekly',
        'Pet Friendly, Direct Sunlight, Intermediate, Light Water'
    ),
    (
        'Peace Lily',
        'Spathiphyllum',
        ...
        1,
        'weekly',
        'Toxic, Low Sunlight, Intermediate, Light Water, Humid Environment'
    ),
    (
        'Madagascar Jasmine',
        'Stephanotis floribunda',
        'https://media.sciencephoto.com/image/b8361860/800wm',
        ...
        0,
        'twice-weekly',
        'Pet Friendly, Direct Sunlight, Pros, Moderate Water, Humid Environment'
    ),
    (
        'Cape Primrose',
        'Streptocarpus',
        'https://www.whiteflowerfarm.com/mas_assets/cache/image/3/e/e/3/16099.Jpg',
        " Streptocarpus aren’t primrose at all, but gesneriads (African violet cousins). They will bloom heavily year-round and can be quite spectacular. They are great for windows, or in artificial light. Unlike violets, each leaf of a streptocarpus will produce 8-10 or more bloom stalks, sequentially, so that plants tend to stay in heavy bloom for long periods of time,",
        'average',
        1,
        'weekly',
        'Pet Friendly, Low Sunlight, Intermediate, Light Water, Cool Environment'
    ),
    (
        'Wandering Jew',
        'Tradescantia zebrina',
        'https://assets.eflorist.com/site/EF-7620/assets/products/PHR_/sku6462268.jpg',
        ...
        1,
        'weekly',
        'Direct Sunlight, Pros, Light Water, Dry Environment'
    ),
    (
        'Chinese Money Plant',
        'Pilea peperomioides',
        'https://s7d1.scene7.com/is/image/terrain/46197901_000_a?$zoom2$',
        'Having a superficial resemblance to pennyworts and growing 30 cm (12 in) tall and wide, it is an erect, evergreen perennial, with round, dark green, peltate leaves up to 10 cm in diameter on a long petiole. The stem axis is greenish to dark brown, usually simple, often upright straight, slightly lignified at the base. In poor growing conditions, the plants lose their leaves in the lower part of the branch axis and thereby assume a very distinctive habit. The plants are completely hairless. Striking are their large, circular, shiny, leaves, which can have a diameter of over 15 centimeters.',
        'average',
        0,
        'weekly',
        'Pet Friendly, Direct Sunlight, Beginners, Light Water, Cool Environment'
    ),
    (
        'Satin Pothos',
        'Scindapsus pictus',
        'https://www.whiteflowerfarm.com/mas_assets/cache/image/4/a/5/5/19029.Jpg',
    ...
    (
        'Yucca',
        'Yucca Elephantipes',
        'https://exoticplantsouq.ae/wp-content/uploads/2020/05/yucca-indoor-indoor-plant-2.jpg',
        ...
        1,
        'bi-weekly',
        'Direct Sunlight, Beginners, Light Water, Dry Environment'
    ),
    (
        'Aloe vera',
        'Aloe vera',
        'https://s7d1.scene7.com/is/image/terrain/53770426_000_a?$zoom2$',
        ...
        1,
        'bi-weekly',
        'Direct Sunlight, Beginners, Moderate Water, Warm Environment'
    ),
    (
        'Prickly Pear',
        'Opuntia',
        'https://cdn.webshopapp.com/shops/30495/files/337923472/cactus-opuntia-in-decorative-pot.jpg',
        'Prickly pears are a subgroup of Opuntia, identified by their wide, flat, branching pads, and are often called nopal cactus or paddle cactus. Most varieties have a combination of detachable spines and tufts of barbed bristles (glochids) that can cause significant allergic skin reactions. There are also spineless varieties like O. ellisiana and others. The pads, flowers and fruit of most varieties are edible after careful cleaning. Most prickly pear plants are found in warm, dry climates like the Southwest, although there are some cold-hardy varieties such as the Eastern prickly pear (O. humifusa). As the plants prepare for winter, pads may begin to look shriveled and wilted, but they will green up quickly in spring.',
        'average',
        1,
        'bi-weekly',
        'Pet Friendly, Direct Sunlight, Intermediate, Light Water, Dry Environment'
    ...
    (
        ...
        0,
        'bi-weekly',
        'Pet Friendly, Direct Sunlight, Beginners, Light Water, Dry Environment'
    ),
    (
        'Jade Plant',
        'Crassula ovata',
        'https://cdn11.bigcommerce.com/s-x68mczjd0x/images/stencil/1280x1280/products/840/782/CRASSULAOVATA1GRULER__11234.1560536907.jpg?c=2',
        ...
        1,
        'bi-weekly',
        'Medium Sunlight, Beignners, Moderate Water, Cool Environment'
    ),
    (
        'Echeveria',
        'Echeveria',
        'https://i.ytimg.com/vi/TOkJwbT_S_E/maxresdefault.jpg',
        ...
        0,
        'bi-weekly',
        'Pet Friendly, Medium Sunlight, Beginners, Light Water, Dry Environment'
    ),
    (
        'English Ivy',
        'Hedera helix',
        'https://m.media-amazon.com/images/I/817b6nMTqhL._AC_SY450_.jpg',
        ...
        1,
        'weekly',
        'Medium Sunlight, Beginners, Light Water, Dry Environment'
    ),
    (
        'Strawberry Begonia',
        'Saxifraga Stolonifera',
        'https://img.plantsam.com/wp-content/uploads/2016/04/Saxifraga-stolonifera.jpg',
        ...
        0,
        'weekly',
        'Direct Sunlight, Beginners, Light Water, Cool Environment'
    ),
    (
        "Azalea",
        "Rhododendron",
        'https://www.avasflowers.net/img/prod_img/avasflowers-pretty-potted-pink-azalea-planter.jpg',
        ...
        1,
        'twice-weekly',
        'Low Sunlight, Beginners, Light Water, Cool Environment'
    ),
    (
        "Baby's Tear's Plant",
        "Soleirolia",
        'https://www.gardenloversclub.com/wp-content/uploads/2019/09/babys-tears-in-pot.jpg',
        ...
        0,
        'twice-weekly',
        'Pet Friendly, Direct Sunlight, Pros, Moderate Water, Cool Environment'
    ),
    (
        "Bird of Paradise",
        "Strelitzia",
        'https://img.crocdn.co.uk/images/products2/pl/20/00/03/35/pl2000033579_card3_lg.jpg',
        ...
        1,
        'weekly',
        'Medium Sunlight, Pros, Moderate Water, Warm Environment'
    ),
    (
        "Bleeding-Heart Vine",
        "Clerodendrum thomsoniae",
        'https://cdn.shopify.com/s/files/1/0067/9346/1858/products/IMG_8661_740x.jpg?v=1603962309',
        ...
        1,
        'weekly',
        'Toxic, Direct Sunlight, Intermediate, Moderate Water, Warm Environment'
    ),
    (
        "Guzmania",
        "Guzmania",
        'https://cdn.shopify.com/s/files/1/1941/1701/products/Bromeliad_Guzmania_500x.jpg?v=1594132742',
        ...
        0,
        'bi-weekly',
        'Pet Friendly, Low Sunlight, Beginners, Light Water, Humid Environment'
    ),
    (
        "Calla Lily",
        "Zantedeschia aethiopica",
        'https://i.pinimg.com/originals/85/39/fe/8539fe6078addc2f637fadfdbe278cfb.jpg',
        ...
        1,
        'daily',
        'Direct Sunlight, Intermeidate, Light Water, Warm Environment'
    ),
    (
        "Cat Palm",
        "Chamaedorea cataractarum",
        'https://mcnamaraflorist.imgix.net/images/itemVariation/cat-palm-20032472405.jpg?auto=format&w=375&h=450&fit=crop',
        ...
        0,
        'weekly',
        'Pet Friendly, Direct Sunlight, Pros, Moderate Water, Warm Environment'
    ),
    (
        "Chrysanthemum",
        "Chrysanthemum",
        'https://plantingman.com/wp-content/uploads/2017/02/Chrysantheium-plant.jpg',
        ...
        1,
        'weekly',
        'Direct Sunlight, Beginners, Moderate Water, Dry Environment'
    ),
    (
        "Cineraria",
        "Pericallis Cruenta",
        'https://media.bunnings.co.nz/Product-384x384/3f79f18b-c2ee-4ac9-a901-3d084a040a37.jpg',
    ...
    (
        "Kaffir Lily",
        "Clivia miniata",
        'https://i.pinimg.com/originals/73/7d/5a/737d5a88db590b7acfc4687de326b8cc.jpg',
        ...
        1,
        'bi-weekly',
        'Toxic, Direct Sunlight, Beginners, Light Water, Warm Environment'
    ),
    (
        "Coleus",
        "Solenostemon",
        'https://c8.alamy.com/comp/XBA9TH/two-coleus-in-flowerpots-solenostemon-scutellarioides-XBA9TH.jpg',
        'Coleus is a fast- growing, hanging houseplant that comes in over 100 different leaf colors, textures, shapes, & designs. It is a member of the mint family. These plants were very popular during the Victorian era but fell out of favor for a while because of the poor plant quality being sold. Today a coleus plant is once again very popular both as an indoor and as an outdoor plant. The colors on the leaves may be a mixture of lavender, cream, pink, maroon, yellow, red, bronze, and various shades of green. The color patterns can be marbled, stripped, or dappled. If you have a very bright area in your home that calls for a hanging plant, then a coleus is perfect for you.',
        'average',
        0,
        'twice-weekly',
        'Medium Sunlight, Intermediate, Light Water, Warm Environment'
    ),
    (
        "Brazilian Snow Plant",
        "Ctenanthe Lubbersiana",
        'https://plantingman.com/wp-content/uploads/2019/05/Ctenanthe-lubbersiana-%E2%80%98Golden-mosaic%E2%80%99.jpg',
        ...
        1,
        'daily',
        'Direct Sunlight, Pros, Light Water, Humid Environment'
    ),
    (
        "Desert Rose",
        "Adenium obesum",
        'https://5.imimg.com/data5/TM/HJ/MY-38022806/adenium-desert-rose-plant-500x500.jpg',
    ...
    (
        "Emerald Gem",
        "Homalomena",
        'https://i.pinimg.com/474x/d9/57/90/d95790293bfd204b5ee94578c59b1147.jpg',
        ...
        0,
        'weekly',
        'Toxic, Medium Sunlight, Pros, Moderate Water, Warm Environment'
    ),
    (
        "Paper Plant",
        "Fatsia Japonica",
        'https://cdn.shopify.com/s/files/1/0253/6701/9565/products/Fatsia-Japonica-Camoflauge-11_1000x1000.jpg?v=1606044970',
        ...
        0,
        'weekly',
        'Medium Sunlight, Intermediate, Moderate Water, Warm Environment'
    ),
    (
        "Fiddle leaf Fig",
        "Ficus lyrata",
        'https://i.pinimg.com/originals/5e/38/79/5e3879e4af262bbd7c5658485fb20e61.jpg',
        ...
        1,
        'bi-weekly',
        'Direct Sunlight, Pros, Moderate Water, Warm Environment'
    ),
    (
        "Lucky Bamboo",
        "Dracaena sanderiana",
        'https://i.pinimg.com/originals/af/a9/c5/afa9c5dac5462ffba9e88badc9a3903f.jpg',
        ...
        1,
        'monthly',
        'Medium Sunlight, Beginners, Moderate Water, Warm Environment'
    ),
    (
        "Moses In The Cradle",
        "Tradescantia spathacea",
        'https://www.logees.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/r/1/r1934-4-large.jpg',
        ...
        1,
        'weekly',
        'Toxic, Direct Sunlight, Beginners, Light Water, Humid Environment'
    ),
    (
        "Poinsettia",
        "Euphorbia pulcherrima",
        'https://i.pinimg.com/originals/c0/ec/44/c0ec4422e346897b83aeb0bd9fe114a5.jpg',
        ...
        1,
        'weekly',
        'Direct Sunlight, Beginners, Light Water, Warm Environment'
    )